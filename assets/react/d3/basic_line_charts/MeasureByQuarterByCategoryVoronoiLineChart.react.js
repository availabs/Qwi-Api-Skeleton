...
var MeasureByQuarterByGeographyVoronoiLineChart = React.createClass({
    ...
    '_update' : function () {
        ...
        console.log([[ -props.margin.left, -props.margin.top], 
                         [ width + props.margin.right, props.height + props.margin.bottom]]);
        console.log('=======================');

        var voronoi = d3.geom.voronoi()
            .x(function(d) { return that._x(d.date); })
            .y(function(d) { return that._y(d[measure]); })
            .clipExtent([[ -props.margin.left, -props.margin.top], 
                         [ width + props.margin.right, props.height + props.margin.bottom]]);
  ...
  function mouseover(d) {
    ...
    focus.attr("transform", "translate(" + that._x(d.date) + "," + that._y(d[measure]) + ")");

    textNode.selectAll('*').remove();

    textNode.style('text-shadow', '5px 5px 5px #000, 5px 5px 5px #000, 5px 5px 5px black, 5px 5px 5px black')
  ...
  function mouseout(d) {
    ...
    '_savePng': function () {
        ...
        theClone.setAttribute('width', width + 5);
